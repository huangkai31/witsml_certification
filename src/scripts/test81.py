...
test(
     ...
     reference_text = '<xsd:maxLength value="64"/>',
...
# Setup valid uids and names with uid of maximum length of specification (64 chars)
#                  1234567890123456789012345678901234567890123456789012345678901234               
set('uidWell',    'Certification-Test-81-well--------FillerFillerFillerFillerFiller')
set('uidWellbore','Certification-Test-81-wellbore----FillerFillerFillerFillerFiller')
set('uidLog',     'Certification-Test-81-log---------FillerFillerFillerFillerFiller')
...
# using uids that have the maximum length allowed 
...
partial_success("Add to store succeeded for well with maximum size uid")
...
WMLS_AddToStore(WMLTYPEIN_WELLBORE, """<?xml version="1.0" encoding="UTF-8"?>
                                       ...
                                       """)
check_ReturnValue_Success()
partial_success("Add to store succeeded for wellbore with maximum size uid")
...
check_ReturnValue_Success()
partial_success("Add to store succeeded for log with maximum size uid")
...
partial_success("Maximum uid length supported for well")
...
partial_success("Maximum uid length supported for wellbore")
...
partial_success("Maximum uid length supported for log")
